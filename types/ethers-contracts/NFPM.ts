...
export interface NFPMInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "PERMIT_TYPEHASH"
...
export interface NFPM extends BaseContract {
  connect(runner?: ContractRunner | null): NFPM;
  waitForDeployment(): Promise<this>;

  interface: NFPMInterface;
