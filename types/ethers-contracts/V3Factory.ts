...
export interface V3FactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "createPool"
      | "enableFeeAmount"
...
export interface V3Factory extends BaseContract {
  connect(runner?: ContractRunner | null): V3Factory;
  waitForDeployment(): Promise<this>;

  interface: V3FactoryInterface;
